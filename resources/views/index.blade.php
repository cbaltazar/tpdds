...
<head>
    ...
    <title>¿Dónde invierto? | Home</title>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            </span> <span class="text-muted text-xs block">Analista de inversiones <b class="caret"></b></span> </span> </a>
                    ...
                    <li> <!--class="active"-->
                        <a href="index.html"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Cuentas</span> <span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-calculator"></i> <span class="nav-label">Indicadores</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Metodologías</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer">
                    <div class="pull-right">
                        Diseño de Sistemas <strong>|</strong> 2017.
                    </div>
                    <div>
                        <strong>Copyright</strong> ¿Dónde invierto? &copy; 2017
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Asesor del Mercado de Valores', 'Bienvenido a AMEVA');
